...
export default function ChannelCard({
  ...
  if (blank) {
    return (
      <div className="wii-channel-ui" style={{ '--wii-channel-bg': 'transparent', opacity: 0.3 }}>
        <svg className="wii-channel-ui-svg" viewBox="806 0 391 217" aria-hidden="true">
          <path className="wii-channel-ui-dimmer" d={CHANNEL_SVG_PATH} />
          <path className="wii-channel-ui-border" d={CHANNEL_SVG_PATH} />
        </svg>
      </div>
    );
  }
