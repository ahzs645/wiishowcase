...
const HINT_STYLE: React.CSSProperties = { marginTop: '10px', fontSize: '13px', opacity: 0.7 };
const PAIR_ANOTHER_STYLE: React.CSSProperties = { marginTop: '12px' };
const CLOSE_HINT_STYLE: React.CSSProperties = { marginTop: '8px' };
        ...
        {state === 'waiting' && companionUrl && (
          <>
            ...
            <div className="pairing-qr">
              <QRCodeSVG value={companionUrl} size={220} level="L" bgColor="#ffffff" fgColor="#000000" />
            </div>
            ...
            <div className="pairing-answer-input">
              <textarea
                ...
                rows={3}
              />
              <button className="pairing-submit" onClick={handleSubmitAnswer} disabled={!answerInput.trim()}>
                Connect
              </button>
            </div>
